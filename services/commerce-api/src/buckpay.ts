...
export interface BuckPayRepository {
  ...
  payOrderWithBuckPay(input:{customerId:string;orderId:string;paymentId:string;idempotencyKey:string;requestFingerprint:string}):Promise<BuckPayOrderPayment>;
}
